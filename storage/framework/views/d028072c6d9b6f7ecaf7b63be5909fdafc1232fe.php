...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #000000">
      ...
      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('authors.index')); ?>">
      ...
      <hr class="sidebar-divider my-0" style="background-color: #18d26e">
        <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('members.index')); ?>">
          <i class="fas fa-fw fa-table"></i>
          <span style="color: #18d26e">Members</span></a>
      </li>
      <hr class="sidebar-divider my-0" style="background-color: #18d26e">
       <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('borrow.index')); ?>">
          <i class="fas fa-fw fa-table"></i>
          <span style="color: #18d26e">Borrows</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('returns.index')); ?>">
          <i class="fas fa-fw fa-table"></i>
...
<?php /**PATH /home/yannaing/Desktop/Library/resources/views/backendtemplate.blade.php ENDPATH**/ ?>